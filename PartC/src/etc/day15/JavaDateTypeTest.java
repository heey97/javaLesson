 ...
 * 3) java.time 패키지의 LocalDate, LocalTime, LocalDateTime 클래스 : jdk 1.8 qjwjsqnxj.
...
public class JavaDateTypeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=====================================================");
        //java.sql.Date는 기본생성자 동작 없습니다. long 타입 인자(ms 단위값)가 필요합니다.
