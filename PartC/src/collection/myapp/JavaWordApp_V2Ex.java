...
public class JavaWordApp_V2Ex {
     ...
     * if(word!=null)
     *      System.out.println("검색 결과 : " + word.getEnglish()+"=I"+word.getKorean()+" 레벨" + word.getLevel()); 
     * else
    ...
    private void printWordList(List<JavaWord> list){
        for(JavaWord word : list) {
            System.out.println(String.format("%-20s %-30s %-15s", 
    ...
    public static void main(String[] args) {
        ...
        JavaWordApp_V2Ex app = new JavaWordApp_V2Ex();
        app.start();
    }
}
